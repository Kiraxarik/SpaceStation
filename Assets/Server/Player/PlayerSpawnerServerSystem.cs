...
/// <summary>
/// Auto-discovers the player ghost prefab (the Prefab+GhostType entity that also
/// carries GhostOwner, which NetCode baking adds to player ghosts specifically)
/// and creates the PlayerSpawner singleton PlayerSpawnServerSystem reads from.
/// Runs once per server session, then disables itself.
/// </summary>
